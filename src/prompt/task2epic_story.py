...
### 2단계: 그루핑
유사한 기능/목적의 Task들을 묶어 Epic 후보 식별

### 3단계: Epic 구성
그룹별로 Epic 제목과 목표 설정

### 4단계: Story 변환
각 Task를 사용자 중심 Story로 변환

### 5단계: 검증
Epic-Story 관계와 포인트 추정 검토
...
- **dependencies에서 참조하는 Story는 같은 Epic 내의 다른 Story title을 사용**
- **의존성이 없는 Story는 dependencies를 빈 배열 []로 설정**
